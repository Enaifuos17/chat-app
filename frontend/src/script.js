...
// import formOther from "../js/script_login";
...
let usernameChat = document.querySelector(".conversation-user-name");
let usernameSide = document.querySelector("span.content-message-name");
// console.log(formOther);

// console.log(arrOfUsernames);

// usernameChat.innerText = arrOfUsernames[0];
// usernameSide.innerText = arrOfUsernames[0];
